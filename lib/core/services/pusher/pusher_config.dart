...
class PusherConfig {
  ...
  String APP_ID = "1964056";
  String API_KEY = "b5e0024b5adfa17ff8a0";
  String SECRET = "7d2677f7f5e9872f4ad8";
  String API_CLUSTER = "ap2";

  Future<void> initPusher(onEvent, {channelName = "ABC-app", userId}) async {
