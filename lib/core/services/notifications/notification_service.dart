...
import 'package:flutter/cupertino.dart' as DefaultRingtoneType;
...
class NotificationServices {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    String? route = receivedAction.payload?['screen'];
    debugPrint('route: from on action recived  $route');

    if (route != '') {
      // Use the global navigator to push the screen
      // navigatorKey.currentState!.context.push(route, extra: extra);
    }

    debugPrint('receivedNotification $receivedAction');
  }
